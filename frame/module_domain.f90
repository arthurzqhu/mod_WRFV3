...
IF ( ASSOCIATED( grid%tkair ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14202,&
...
IF ( ASSOCIATED( grid%dzo1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14209,&
...
IF ( ASSOCIATED( grid%cto1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14251,&
...
IF ( ASSOCIATED( grid%flo1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14265,&
...
IF ( ASSOCIATED( grid%tssn2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14307,&
...
IF ( ASSOCIATED( grid%bwo2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14321,&
...
IF ( ASSOCIATED( grid%dzo3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14377,&
...
IF ( ASSOCIATED( grid%tssn3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14391,&
...
IF ( ASSOCIATED( grid%cto3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14419,&
...
IF ( ASSOCIATED( grid%fio3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14426,&
...
IF ( ASSOCIATED( grid%tssn4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14475,&
...
IF ( ASSOCIATED( grid%bwo4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14489,&
...
IF ( ASSOCIATED( grid%savedtke12d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14559,&
...
IF ( ASSOCIATED( grid%t_grnd2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14587,&
...
IF ( ASSOCIATED( grid%t_lake3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14594,&
...
IF ( ASSOCIATED( grid%lake_icefrac3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14601,&
...
IF ( ASSOCIATED( grid%h2osoi_liq3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14636,&
...
IF ( ASSOCIATED( grid%watsat3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14671,&
...
IF ( ASSOCIATED( grid%csol3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14678,&
...
IF ( ASSOCIATED( grid%rh_pl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14734,&
...
IF ( ASSOCIATED( grid%q_pl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14762,&
...
IF ( ASSOCIATED( grid%v_zl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14783,&
...
IF ( ASSOCIATED( grid%t_zl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14790,&
...
IF ( ASSOCIATED( grid%ght_zl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14804,&
...
IF ( ASSOCIATED( grid%q_zl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14825,&
...
IF ( ASSOCIATED( grid%grpl_flx_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14839,&
...
IF ( ASSOCIATED( grid%refd_com ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14846,&
...
IF ( ASSOCIATED( grid%qicing_lg_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14916,&
...
IF ( ASSOCIATED( grid%afwa_wchill ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14958,&
...
IF ( ASSOCIATED( grid%afwa_llturbsvr ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15014,&
...
IF ( ASSOCIATED( grid%afwa_totprecip ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15028,&
...
IF ( ASSOCIATED( grid%afwa_rain ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15035,&
...
IF ( ASSOCIATED( grid%afwa_vis_dust ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15084,&
...
IF ( ASSOCIATED( grid%tornado_mask ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15196,&
...
IF ( ASSOCIATED( grid%tornado_dur ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15203,&
...
IF ( ASSOCIATED( grid%psfc_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15210,&
...
IF ( ASSOCIATED( grid%th2_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15238,&
...
IF ( ASSOCIATED( grid%hfx_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15266,&
...
IF ( ASSOCIATED( grid%lwupt_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15322,&
...
IF ( ASSOCIATED( grid%lwdnt_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15329,&
...
IF ( ASSOCIATED( grid%u10_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15371,&
...
IF ( ASSOCIATED( grid%swupt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15427,&
...
IF ( ASSOCIATED( grid%swdnt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15434,&
...
IF ( ASSOCIATED( grid%lwupt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15441,&
...
IF ( ASSOCIATED( grid%th2_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15476,&
...
IF ( ASSOCIATED( grid%u10_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15490,&
...
IF ( ASSOCIATED( grid%v10_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15497,&
...
IF ( ASSOCIATED( grid%kext_ql ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15574,&
...
IF ( ASSOCIATED( grid%kext_qip ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15588,&
...
IF ( ASSOCIATED( grid%kext_qg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15609,&
...
IF ( ASSOCIATED( grid%kext_qa ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15623,&
...
IF ( ASSOCIATED( grid%kext_ft_qid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15644,&
...
IF ( ASSOCIATED( grid%height ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15665,&
...
IF ( ASSOCIATED( grid%elecy ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15721,&
...
IF ( ASSOCIATED( grid%light ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15742,&
...
IF ( ASSOCIATED( grid%field_t_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15798,&
...
IF ( ASSOCIATED( grid%c2h ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15819,&
...
IF ( ASSOCIATED( grid%bh ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15826,&
...
IF ( ASSOCIATED( grid%c1f ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15833,&
...
IF ( ASSOCIATED( grid%c4h ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15854,&
   ...
   END SUBROUTINE init_module_domain
      ...
      FUNCTION domain_get_current_time ( grid ) RESULT ( current_time ) 
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",16439,&
      ...
      SUBROUTINE domain_clock_get( grid, current_time,                &
        ...
        IF ( PRESENT( time_stepstr_frac ) ) THEN
          ...
          CALL WRFU_TimeIntervalGet( lcl_time_step, timeString=tmp_str, &
                                     Sn=Sn, Sd=Sd, rc=rc )
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",16803,&
              'domain_clock_get:  WRFU_TimeIntervalGet() failed' )
          ENDIF
        ...
        IF ( PRESENT( current_timestr_frac ) ) THEN
          ...
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",16831,&
      ...
      SUBROUTINE domain_clock_create( grid, StartTime, &
        ...
        grid%domain_clock = WRFU_ClockCreate( TimeStep= TimeStep,  &
                                              ...
                                              rc=rc )
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",16938,&
      ...
      SUBROUTINE domain_alarm_create( grid, alarm_id, interval, &
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",17015,&
      ...
      SUBROUTINE domain_clockadvance ( grid )
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",17100,&
